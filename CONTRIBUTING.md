...
- Follow the instructions in the general contributing guide to fork and clone this repo locally, and work from there. This is necessary, if you wanna edit and create alot of changes across multiple files as a part of single PR.

You must keep in this in mind before opening a PR, while working on an existing or a new lesson you **must** follow our [Guide for Markdown styling]() to ensure the layout and formatting is consistent across this repository.

Also be of note before submitting a PR for any lesson, you must almost always view the documents you've made to ensure the lesson has a proper Markdown formatting and it is rendering correctly.